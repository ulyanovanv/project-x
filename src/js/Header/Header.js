...
export class Header extends React.Component {
  ...
  render(){
    return (<section className="header row">
      ...
      <div className="col-xs-offset-2 col-xs-5 col-sm-offset-3 col-md-offset-2 col-sm-5 col-md-5 row">
        <div className="custom-settings col-xs-12 col-md-9 col-sm-8">
          <ButtonCustomerSettings handleClick={(value) => {this.handleClick(value)}}
                                  country={this.props.country}
                                  language={this.props.language}
                                  currency={this.props.currency}/>
        </div>
        <div className="registration col-md-3 col-sm-4">
