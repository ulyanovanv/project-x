...
const LISTS_NAMES = [{country: COUNTRIES},{language:LANGUAGES},{currency:CURRENCIES}];

export class FormCustomerSettings extends React.Component {
  constructor(props){
    super(props);
    this.state = {country: COUNTRIES[0], language: LANGUAGES[0].language, currency: CURRENCIES[0] };
  ...
  renderOptions(category) {
    if (category === COUNTRIES || category === CURRENCIES) {
